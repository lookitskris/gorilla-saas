...
# app naming
APP_NAME="app-api"
APP_DEPLOYMENT_NAME="appServiceApi"
...
BASE_DIR="${REPO_BASE}/src/Saas.Application.Service/deployment"
...
GITHUB_ACTION_WORKFLOW_FILE="${WORKFLOW_BASE}/app-service-api-deploy.yml"
ACT_LOCAL_WORKFLOW_DEBUG_FILE="${ACT_DIR}/workflows/app-service-api-deploy-debug.yml"
