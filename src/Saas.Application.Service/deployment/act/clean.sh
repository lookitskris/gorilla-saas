...
host_deployment_dir="${repo_base}/src/Saas.Application.Service/deployment"
container_deployment_dir="/asdk/src/Saas.Application.Service/deployment"
...
docker run \
    ...
    --env "ASDK_DEPLOYMENT_SCRIPT_PROJECT_BASE=/asdk/src/Saas.Application.Service/deployment" \
